...
public class ProcesadorYodafy extends Thread{
	...
	public ProcesadorYodafy(Socket socketServicio, int nHebra) {
	...
	void procesa(){
		...
		try {
			...
			do{
				...
				System.out.println("Hebra : "+nHebra+" Recibido : "+datosRecibidos.length());
				...
				System.out.println("Hebra : "+nHebra+" Yodificando");
				...
				System.out.println("Hebra : " + nHebra + " Enviando respuesta");
			} while (true);
